...
Gem::Specification.new do |s|
  ...
  s.date = "2012-01-24"
  s.description = "TODO: couchdb view generation could take a while. you could build temp views, then copy them in one shot"
  ...
  s.summary = "TODO: couchdb views index copy trick helper"
